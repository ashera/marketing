...
- **Spend summary:** 2× 1080p `ip_detected` (-300) + 1× 720p `ip_detected` (-75) + 2× completed 480p tests (-105) = -480 charged; failed tests refunded. **Request refunds** for the 3 `ip_detected` jobs (`ed2937f6…`, `aac7bf99…`, `9ef01d0b…`) via support. Upgrade to a native 1080p final once credits allow (480p-test first).
